...
namespace SpotifyWebApi
{
    ...
    /// 
    /// </summary>
    public class AudioFeatures : BaseModel
    {
        /// <summary>
        ...
        /// word tracks are clearly "vocal". The closer the instrumentalness value is to 1.0, the greater likelihood the track contains 
        ...
        /// are probably made entirely of spoken words. Values between 0.33 and 0.66 describe tracks that may contain both music 
        /// and speech, either in sections or layered, including such cases as rap music. Values below 0.33 most likely represent 
